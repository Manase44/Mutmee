...
import { upload_preset, cloud_name, server_url } from '../../../utils/configurations';
    ...
    const handleArticleForm = useFormik({
        ...
        onSubmit: async (data) => {
            ...
            if (imageInput && articleContent) {
                ...
                setArticleError(null)
                const imageUrl = await uploadImage(imageInput, upload_preset, cloud_name);
                data.articleImageUrl = imageUrl;
            ...
            <form onSubmit={handleArticleForm.handleSubmit}>
                <div className="form-input">
                    ...
                    <div className="input-wrapper">
                        <input type="text" name="articleTitle" id="articleTitle" onBlur={handleArticleForm.handleBlur} onChange={handleArticleForm.handleChange} value={handleArticleForm.values.articleTitle} />
                    </div>
                    {handleArticleForm.errors.articleTitle && handleArticleForm.touched.articleTitle && <p className='error'>{handleArticleForm.errors.articleTitle}</p>}
                </div>
                ...
                {imageInput && <p className='article-image-input-name'>{imageInput?.name}</p>}
                <ReactQuill className="article-editor" theme="snow" value={articleContent} onChange={setArticleContent} />
